...
pt.Parser.prototype.read = function(filename) {
    this.input = new pt.InputStream(filename);
    this.skipper = null;
    this.cache = {};
};
...
pt.Parser.prototype.testAny = function(ids) {
...
pt.Parser.prototype.testAll = function(ids) {
    var state = this.getState();
    var r = true;
    try {
        for (var i = 0, l = ids.length; i < l; i++) {
...
pt.Parser.prototype.matchAny = function(ids) {
    for (var i = 0, l = ids.length; i < l; i++) {
        var id = ids[i];
        if (this.test(id)) {
